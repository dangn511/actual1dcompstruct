...
module stateCounter_3 (
  ...
  reg [22:0] M_stateCounter1_d, M_stateCounter1_q = 1'h0;
  
  reg [21:0] M_stateCounter2_d, M_stateCounter2_q = 1'h0;
  
  reg [20:0] M_stateCounter3_d, M_stateCounter3_q = 1'h0;
  ...
  always @* begin
    ...
    inc_state1 = M_stateCounter1_q[22+0-:1];
    M_stateCounter1_d = M_stateCounter1_q + 1'h1;
    if (M_stateCounter1_q[22+0-:1] == 1'h1) begin
      M_stateCounter1_d[22+0-:1] = 1'h0;
    end
    inc_state2 = M_stateCounter2_q[21+0-:1];
    M_stateCounter2_d = M_stateCounter2_q + 1'h1;
    if (M_stateCounter2_q[21+0-:1] == 1'h1) begin
      M_stateCounter2_d[21+0-:1] = 1'h0;
    end
    inc_state3 = M_stateCounter3_q[20+0-:1];
    M_stateCounter3_d = M_stateCounter3_q + 1'h1;
    if (M_stateCounter3_q[20+0-:1] == 1'h1) begin
      M_stateCounter3_d[20+0-:1] = 1'h0;
    end
  end
